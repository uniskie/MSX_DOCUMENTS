...
|画面モード | 基本                  | 裏                     | 備考                                  |
|-----------|-----------------------|------------------------|---------------------------------------|
|SCREEN 0   | $0000 : R#2=```$00``` | $0400 : R#2=```$01```  | ﾊﾟﾀｰﾝｼﾞｪﾈﾚｰﾀ（$0800,$0C00）以外は自由 |
|SCREEN 1   | $1800 : R#2=```$06``` | $1C00 : R#2=```$07```  | 少し余裕がある                        |
|SCREEN 2   | $1800 : R#2=```$06``` | $1C00 : R#2=```$07```  | 他に余裕がない                        |
